...
const Services: FC = () => {
	...
	const pageDescription = 'We are a web development/design studio dedicated' +
		...
		<div className={s.services}>
			<div>
				...
				<ul className={s.servicesList}>
					{servicesList.map(item => (<li key={item}>{item}</li>))}
				</ul>
			</div>
			<p className={s.servicesDescription}>
				...
				revamping an existing site, or looking to establish an online presence,
				as an expert developers we use the latest technologies to bring your
				vision to life.
				<br/>
				<br/>
